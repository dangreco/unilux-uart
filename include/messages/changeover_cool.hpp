...
/// @file changeover_cool.hpp
/// @brief Typed WMMM message carrying the auto-mode cooling changeover temp.
///
/// The ChangeoverCool message (id @c 0x5E, thermostat parameter P17) carries a
...
/// is the temperature at which auto mode switches to cooling. Typical range is
/// 20.0..40.0 °C.
///
/// @code
// clang-format off
...
/// @brief Auto-mode cooling changeover temperature (WMMM message id @c 0x5E).
class ChangeoverCool : public unilux::Message {

public:
  /// WMMM message id for this message.
  static constexpr uint8_t ID = 0x5E;
  ...
  ChangeoverCool() = default;
  explicit ChangeoverCool(float value) : value(value) {}
  ...
  std::string to_string() const override {
    char buf[40];
    std::snprintf(buf, sizeof(buf), "ChangeoverCool(%.1f)",
                  static_cast<double>(value));
    return buf;
  }

  /// @brief Decode a ChangeoverCool message from a generic WMMM frame.
  ...
  static std::optional<ChangeoverCool> decode(const Frame &frame) {
